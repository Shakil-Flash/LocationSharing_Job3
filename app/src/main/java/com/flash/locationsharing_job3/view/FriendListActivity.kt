...
import com.flash.locationsharing_job3.databinding.ActivityFriendListBinding
import com.flash.locationsharing_job3.repo.UserRepository
import com.flash.locationsharing_job3.viewmodel.FriendListViewModel
...
class FriendListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.layoutMyProfile.setOnClickListener {
            val uid = repository.getCurrentUserId() ?: return@setOnClickListener
    ...
    private fun updateLocationAutomatically() {
        repository.updateLocationAuto(this) { success ->
            if (success) {
                loadCurrentUser()
            } else {
